...
if (array_key_exists('qid', $_POST)) {
    ...
    $query="select q.*,a.answer as correct from question q,schedule s,answers a "
            . "where q.question_paper_id = s.question_paper_id and a.question_id=q.id and a.schedule_id=s.id and s.id= ".$_POST['sid']." and q.id=".$_POST['qid']." "
            . "and a.user_id=".$_POST['uid'];
    //echo $query;
