...
<?php
    ...
    $query="select q.id,q.question,q.value,q.question_type,q.a,q.b,q.c,q.d,q.answer,a.answer "
            ...
            . "and a.user_id=".$_SESSION['id']." and a.schedule_id=".$_POST['sid']." and a.schedule_id=s.id";
...
?>
     <div class="well well-sm">
         ...
         {
         ?>    
         <button onClick="loadQuestion(<?php echo $id; ?>)" class="list-group-item list-group-item-success">
